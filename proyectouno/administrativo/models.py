...
class Estudiante(models.Model):
    ...
    def obtener_costo_total(self):
        return self.lasmatriculas.all().aggregate(Sum('costo'))['costo__sum']
...
class Modulo(models.Model):
    opciones_modulo = (('1', 'Primero'), ('2', 'Segundo'), ('3', 'Tercero'),('4', 'Cuarto'),('5', 'Quinto'),('6', 'Sexto'),)
...
class Matricula(models.Model):
    ...
    def __str__(self):
        return "Matricula: Estudiante(%s) - Modulo(%s) - Costo: %s" % (self.estudiante, self.modulo.nombre, self.costo)
